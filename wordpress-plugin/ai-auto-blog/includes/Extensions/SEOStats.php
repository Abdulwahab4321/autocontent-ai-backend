 ...
 * 
 * Calculates SEO metrics for posts generated by AI Auto Blog campaigns
 */
class SEOStats {
    
    /**
     * Get all SEO statistics for AI Auto Blog posts
     * 
     * @return array Array of SEO statistics
     */
    public static function get_stats() {
        // Get all posts generated by AI Auto Blog campaigns
        $aab_posts = get_posts([
            'post_type' => 'post',
